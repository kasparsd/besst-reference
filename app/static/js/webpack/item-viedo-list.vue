      ...
      <div class="btn-group-top">
        <div class="icons">
          <div
            class="icon-item add"
            @click="showAddDialog"
            v-if="authList[Core.Const.AUTH_LIST.productProductTrainingEdit]"
            :title="$t('addVideo')"
          ></div>
        </div>
      </div>
          ...
          <tr v-for="item in videoList">
            ...
            <td>
              ...
              <a
                ...
                v-if="authList[Core.Const.AUTH_LIST.productProductTrainingDelete]"
                >{{ $t("delete") }}</a
              >
            </td>
          </tr>
...
export default {
  ...
  i18n: {
    messages: {
      fr: FR.Component.Product.ItemVideoList,
