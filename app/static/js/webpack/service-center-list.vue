<template>
  <div class="brand-service-center-list">
      ...
      <div class="btn-group-top">
        <div class="icons">
          <div
            class="icon-item add"
            @click="showAddDialog"
            v-if="authList[Core.Const.AUTH_LIST.ticketSCAdd]"
          ></div>
        </div>
      </div>
    </div>
              ...
              <td class="icon-td">
                <div class="icons">
                  <div
                    ...
                    v-if="authList[Core.Const.AUTH_LIST.ticketSCEdit]"
                    :title="$t('op.edit')"
                  ></div>
                </div>
                <div class="icons">
                  <div
                    class="icon-item account"
                    @click.stop="goToAccountList(item)"
                    :title="$t('op.account')"
                  ></div>
                </div>
                <div class="icons">
    ...
    <el-dialog
      ...
      :visible.sync="dialogDeleteCenterVisible"
      size="tiny"
    >
      <p>{{ $t("deleteDialog.content") }}</p>
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="deleteServiceCenter">{{ $t("yes") }}</el-button>
        <el-button type="primary" @click="dialogDeleteCenterVisible = false">{{
          $t("no")
        }}</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog
      :title="dialogText"
      :visible.sync="dialogEditServiceCenterVisible"
    ...
    >
      ...
      <div class="company-item">
        ...
        <div class="content">
          <el-input v-model="selectOrg.address"> </el-input>
        </div>
      </div>
      <div class="company-item">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="editServiceCenter">{{
          $t("confirm")
        }}</el-button>
        <el-button type="primary" @click="dialogEditServiceCenterVisible = false">{{
          $t("cancel")
        }}</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog
      ...
      :visible.sync="dialogDetailServiceCenterVisible"
      custom-class="edit-dialog"
      class="dialog-company"
    >
...
export default {
  ...
  i18n: {
    messages: {
      fr: FR.Components.ServiceCenter.serviceCenterList,
...
// WEBPACK FOOTER //
// service-center-list.vue?06d88508