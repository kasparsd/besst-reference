  ...
  <div class="handle-up-ticket-list">
    ...
    <div class="table-wrap">
      <table class="table-content" border="0" cellspacing="0" cellpadding="0">
        <thead>
          <td v-for="(item, index) in tableHead" :class="{ 'al-right': index === 0 }">
            {{ item }}
          </td>
        </thead>
        <tbody>
...
export default {
  ...
  i18n: {
    messages: {
      fr: FR.ServiceCenter.handleUpTicketList,
  ...
  methods: {
    ...
    getHandleUpTicketList() {
      Core.Api.Ticket.getTicketOfHandleUp(
...
// WEBPACK FOOTER //
// handle-up-ticket-list.vue?7b27c342