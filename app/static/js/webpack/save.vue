  ...
  <div class="brand-model-save">
    ...
    <el-dialog :title="$t('attrList')" :visible.sync="dialogAttrVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="preview" @click="getUpperAttrDefList">{{
          $t("confirm")
        }}</el-button>
  ...
  methods: {
    ...
    getBrandName() {
      ...
      Core.Api.Brand.getAllBrandList().then((res) => {
        ...
        let brandList = res.brand_list.filter(
          (item) => item.id == that.$route.query.brandId
        );
