<template>
  <div class="forget">
    ...
    <div class="main-warp">
      ...
      <el-button type="primary" class="next" @click="resetPassword">{{
        $t("resetPassword")
      }}</el-button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    resetPassword() {
      ...
      Core.Api.Common.checkEmailVCode(
        this.account.email,
        this.account.validationCode
      ).then((res) => {
        Core.Api.User.resetPassword(
          this.account.email,
