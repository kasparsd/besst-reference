            ...
            <div class="remark-row">
              <el-row class="error-row" v-for="code in error" v-bind:key="code.name">
                ...
                <div class="error-solution">
                  ...
                  <p class="error-text pl-30" v-for="(item, index) in code.solution">
                    {{ item }}
                  </p>
                </div>
              </el-row>
          ...
          <el-collapse-item :title="$t('diagnosis.controller')" name="3">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="label-title">{{ $t('cNam.hardwareVersion') }}</div>
                <div class="content">
                  {{ device ? device.controller.hardVersion : '-' }}
                </div>
              </li>
              <li class="list-group-item" v-if="!isCan">
              ...
              <li class="list-group-item" v-if="!isCan">
                ...
                <div class="content">
                  {{ device ? device.controller.maxCurrent : '-' }}
                </div>
              </li>
              <div class="list-group-item" v-if="isCan">
                <div class="label-title">{{ $t('cNam.speedLimit') }}</div>
                <div class="content">
                  {{ device ? device.controller.speedLimit : '-' }}
                </div>
              </div>
              <div class="list-group-item" v-if="isCan">
                <div class="label-title">{{ $t('cNam.wheelDiameter') }}</div>
                <div class="content">
                  {{ device ? device.controller.wheelDiameter : '-' }}
                </div>
              </div>
              <div class="list-group-item" v-if="isCan">
                <div class="label-title">{{ $t('cNam.circumference') }}</div>
                <div class="content">
                  {{ device ? device.controller.circumference : '-' }}
                </div>
              </div>
            </ul>
          </el-collapse-item>
          <el-collapse-item :title="$t('diagnosis.battery')" name="3">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                ...
                <div class="content">
                  {{ device ? device.battery.leftCapacity : '-' }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t('cNam.fullChargeCapacity') }}(mAh)</div>
                <div class="content">
                  {{ device ? device.battery.fullChargerCapacity : '-' }}
                </div>
              </li>
              <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <div class="content">
                  {{ device ? device.battery.maxChargeInterval : '-' }}
                </div>
              </li>
            </ul>
          </el-collapse-item>
          <el-collapse-item :title="$t('diagnosis.sensor')" name="3" v-if="isCan">
            <ul class="list-group">
              ...
              <li class="list-group-item">
                <div class="label-title">{{ $t('cNam.hardwareVersion') }}</div>
                <div class="content">
                  {{ device ? device.pedalSensor.hardVersion : '-' }}
                </div>
              </li>
            </ul>
          </el-collapse-item>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        i18n: {
            messages: {
                fr: FR.Components.Diagnosis.report,
