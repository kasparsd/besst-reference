 ...
 * @LastEditTime: 2022-07-22 16:13:01
    ...
    <div class="left table-box">
      ...
      <div class="table-start">
        <el-form :inline="true" :model="formSearch">
          <el-form-item>
            <el-input v-model.trim="formSearch.source_id" placeholder="订单号"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="formSearch.item_name" placeholder="型号"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="formSearch.object_sn" placeholder="SN"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="table-main">
        ...
        >
          ...
          <el-table-column prop="sourceId" label="订单号" width="150"> </el-table-column>
          <el-table-column
            prop="customerId"
            label="客户名称"
          ...
          <el-table-column prop="item_name" label="型号" min-width="220">
          </el-table-column>
