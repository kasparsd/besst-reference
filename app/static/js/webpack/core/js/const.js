function Const() {
  return {
    ...
    NET: {
      ...
      // END_POINT: 'http://192.168.1.202:9898/client/1', //本地test
      // END_POINT: 'http://dev.acey.cn:9898/client/1',
      ...
      //
      // END_POINT: 'http://192.168.0.197:7109/client/1',  //李恒
      // END_POINT: 'http://192.168.0.141:7109/client/1',
      // END_POINT: 'http://139.196.174.48:9898/client/1',
      // END_POINT: 'http://139.196.174.48:9898/client/1',
      ...
      // FILE_UPLOAD_END_POINT: 'http://192.168.1.202:9898/file/file-upload', // 本地test
      FILE_UPLOAD_END_POINT: 'http://test.api.besst.bafang-service.com/file/file-upload', // 本地 测试 dev
    ...
    wheelDiameters: [
      ...
      { value: '4001', label: '20', max: '1920', min: '1290' },
      { value: '6001', label: '22', max: '1920', min: '1290' },
      { value: '7001', label: '23', max: '1920', min: '1290' },
      { value: '8001', label: '24', max: '2200', min: '1290' },
      { value: '9001', label: '25', max: '2200', min: '1800' },
      { value: 'A001', label: '26', max: '2510', min: '1800' },
      ...
      { value: '201C', label: '450', max: '1600', min: '1208' },
    ...
    TEST_ERROR_CODE: {
      ...
      7: {
        ...
        solution: ['Change a new battery to check if the battery is available.', 'Change a new controller to check if the controller is available.'],
      ...
      15: {
        ...
        solution: ['Change the controller to check the controller is available.'],
        target: ['Controller', 'Motor']
      },
      ...
      27: {
        ...
        solution: ['Using the BESST tool update the controller. If the problem still occurs, please change the motor.'],
        target: ['Controller', 'Motor']
      },
      ...
      35: {
        ...
        solution: ['Using the BESST tool update the controller to see if this resolves the problem. If not, please change the motor.'],
        target: ['Controller', 'Motor']
      },
      ...
      41: {
        ...
        solution: ['Please change the battery.'],
        target: ['Battery']
      },
      ...
      42: {
        ...
        solution: ['Please Charge the battery. If the problem still occurs, please change the battery.'],
        target: ['Battery']
      },
      ...
      45: {
        ...
        solution: ['Please let the bike to cool down.If the problem still occurs, please change the battery.'],
        target: ['Battery']
      },
      ...
      46: {
        ...
        solution: ['Please bring the battery to room temperature.If the problem still occurs, please change the battery.'],
        target: ['Battery']
      },
      ...
      71: {
        ...
        solution: ['Using the BESST tool update the Display', 'Change the display.', 'please change the electronic lock'],
      ...
      81: {
        ...
        solution: ['Using the BESST tool update the display to see if this resolves the problem. If not, please change the display.'],
        target: ['Display']
      }
    },
