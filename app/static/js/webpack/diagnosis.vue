<template>
  <div class="my-diagnosis-container">
    <div class="switch">
      <div class="select">
        <div class="select-area" :class="{ active: isActive }" @click="selectItemDefect()">
          {{ $t('diagnosisElectronic') }}
        </div>
        <div class="select-area" :class="{ active: !isActive }" @click="cancelSelectDefect()">
          {{ $t('diagnosisMechanic') }}
        </div>
      </div>
    </div>
    <div v-if="!dialogDefectVisible" class="switch-body">
      <div class="switch-container">
          ...
          <div class="content">
            ...
            <div class="content-left">
              ...
              <div class="content-select" :class="{ connect: isConnected }">
                <div class="select-item connect" @click="showItemSelectDialog(1)">
                  {{ $t('cNam.select') }}
                </div>
                <!--<span class="connection" @click = "readInfo">Read</span>-->
                <span class="connection" style="cursor: pointer; display: flex">
              ...
              <div class="connection-item">
                <template v-for="(item, index) in connectionSelectDisplay">
                  <div class="info-item" :key="index" @click="showDetail(item)" :class="{ select: item.No === testSelect.No }">
                    <div class="item-info">
                      <div class="item-icon">
                        <img :src="item.img" />
                      </div>
              ...
              <div class="content-select" :class="{ connect: canTest }">
                <div class="select-item connect" @click="showItemSelectDialog(2)">
                  {{ $t('cNam.select') }}
                </div>
                <span class="connection" style="cursor: pointer; display: flex">
              ...
              <div class="connection-item">
                <template v-for="(item, index) in testSelectDisplay">
                  <div class="info-item" @click="showTestDiv(item, index)" :key="index" :class="{ select: item.No == testSelect.No }">
                    <div class="item-info">
                      <div class="item-icon">
                        <img :src="item.img" />
                      </div>
                    ...
                    <div class="result-wrap">
                      ...
                      <template v-if="startTest">
                        <span class="option" :class="{ check: item.okOrFail == 1 }" @click.stop="changeOption(item, 1)">{{ $t('ok') }}</span>
                        <span class="option" :class="{ fail: item.okOrFail == 2 }" @click.stop="changeOption(item, 2)">{{ $t('fail') }}</span>
                      </template>
                    </div>
                    ...
                    <div class="replace-detail" v-if="!item.detail"></div>
                  </div>
                </template>
              </div>
                ...
                <div class="slide-content" v-if="slideDisplay && !detailVisible">
                  ...
                  <div class="slide-content-bottom before-connect" v-if="!isConnected">
                    ...
                    <div class="system-txt">
                      <span class="title step"
                        >{{ $t('step') }} 1 : <span>{{ $t('step11') }} </span><br />
                        <span class="next-line" v-if="!isCan">{{ $t('step12') }}<br /></span>
                        <span class="next-line"
                          >{{ $t('click') }} <span class="highlight">{{ $t('cNam.connect') }}</span
                          >". {{ $t('step13') }}
                        </span>
                        <div class="green"></div>
                      </span>
                  ...
                  <div class="slide-content-bottom after-connect" v-if="isConnected && !isHelp">
                    ...
                    <div class="system-txt">
                      ...
                      <span class="title step" v-if="isCan"
                        >{{ $t('step') }} 3 : <span> {{ $t('step232') }}</span
                        ><br />
                      </span>
                      <span class="title step" v-else
                        >{{ $t('step') }} 3 : <span> {{ $t('step23') }}</span
                        ><br />
                      </span>
              ...
              <template v-if="testSelect.No < 8 && testSelect.No >= 0 && !detailVisible">
                <div class="test-system-item">
                  <div class="throttle" v-if="testSelect.No == 0">
                    ...
                    <img class="display-ok" src="../../assets/images/diagnosis/icon-test-light.png" v-if="lightFlag.throttle" />
                    <img class="display-ok" src="../../assets/images/diagnosis/icon-test-unlight.png" v-else />
                    <div class="clear-20"></div>
                    {{ $t('start11') }}
                  ...
                  <div class="brake" v-if="testSelect.No == 1">
                    <div>
                      <div class="data mark">
                        <p>{{ $t('analogLight') }}</p>
                        <p>
                          <img class="display-ok" src="../../assets/images/diagnosis/icon-test-light.png" v-if="lightFlag.brake" />
                          <img class="display-ok" src="../../assets/images/diagnosis/icon-test-unlight.png" v-else />
                        </p>
                      </div>
                    ...
                    <div>
                      <div class="data mark">
                        <el-button class="gray-button" @click="showTestDiv(testSelectDisplay[currentIndex + 1], currentIndex + 1)">{{
                          $t('start37')
                        }}</el-button>
                      </div>
                      <div class="data img-wrap">
                    ...
                    <div>
                      <div class="data mark">
                        ...
                        <el-button
                          ...
                          style=""
                          @click="
                            breakReleaseFail = !breakReleaseFail
                            breakHoldOk = false
                          "
                          :class="{ active: breakReleaseFail }"
                          >{{ $t('brake08') }}</el-button
                        >
                      </div>
                      <div class="data img-wrap">
                  ...
                  <div class="light" v-if="testSelect.No == 2">
                    <div>
                      <div class="data mark">
                        <p>{{ $t('analogLight') }}</p>
                        <p>
                          <img class="display-ok" src="../../assets/images/diagnosis/icon-test-light.png" v-if="lightFlag.light" />
                          <img class="display-ok" src="../../assets/images/diagnosis/icon-test-unlight.png" v-else />
                        </p>
                      </div>
                      <div class="data img-wrap">
                        ...
                        <span>
                          {{ $t('light01') }}&nbsp;<img src="../../assets/images/icon/head-light-inactive.png" class="light-img" />
                          / "+"
                        </span>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="data mark">
                        ...
                        <el-button
                          type="info"
                          @click="
                            lightOnFail = !lightOnFail
                            lightOnOk = false
                          "
                          :class="{ active: lightOnFail }"
                          >{{ $t('light08') }}</el-button
                        >
                      </div>
                      <div class="data img-wrap">
                    ...
                    <div>
                      <div class="data mark">
                        <el-button
                          type="info"
                          @click="
                            lightOFFOk = !lightOFFOk
                            lightOFFFail = false
                          "
                          :class="{ active: lightOFFOk }"
                          >{{ $t('light09') }}</el-button
                        >
                        <br />
                        <el-button
                          type="info"
                          @click="
                            lightOFFFail = !lightOFFFail
                            lightOFFOk = false
                          "
                          :class="{ active: lightOFFFail }"
                          >{{ $t('light10') }}</el-button
                        >
                      </div>
                      <div class="data img-wrap">
                  ...
                  <div class="pedal" v-if="testSelect.No == 5">
                    <el-switch v-model="cadenceOrTorque" on-text="S" off-text="T" class="fixSwitch" @change="pedalChange"> </el-switch>
                  ...
                  <div class="walk-assistance" v-if="testSelect.No === 6">
                    <div>
                      <div class="data mark">
                        <p v-if="levelIsChecked">
                          <label>{{ $t('cNam.hmiLevel') }}:</label>
                          <el-input v-model="testLevel"> </el-input>
                        </p>
                        <p>
                          <label>{{ $t('cNam.conSpeed') }}:</label>
                          <el-input v-model="testData.wheelSpeed" style="width: 110px">
                    ...
                    <div>
                      <div class="data mark">
                        <el-button class="gray-button">Note</el-button>
                      </div>
                      <div class="data img-wrap">
                        <p>
                          {{ $t('walk06') }}
                    ...
                    <div>
                      ...
                      <div class="data img-wrap">
                        <p>
                          {{ $t('walk03') }}<img src="../../assets/images/diagnosis/icon-new-walk-assistance.png" class="light-img" />
                          {{ $t('walk04') }}
                        </p>
                        <p>
                          {{ $t('walk01') }}<img src="../../assets/images/diagnosis/icon-new-walk-assistance.png" class="light-img" />
                          {{ $t('walk02') }}
                        </p>
                      </div>
                    </div>
                  ...
                  <div class="btn-row" v-if="!switchTest && testSelectDisplay.length > 0">
                    <span>
                      <el-button
                        ...
                        v-if="testSelect.No != testSelectDisplay[0].No"
                        >{{ $t('start36') }}</el-button
                      >
                    ...
                    <span>
                      <template v-if="testSelect.No !== 7">
                        ...
                        <el-button class="gray-button" @click="showTestDiv('', -1)">{{ $t('cNam.cancel') }}</el-button>
                      </template>
                      <template v-else>
        ...
        <el-dialog
          :title="$t('cNam.select')"
          :visible.sync="testSelectDialogVisible"
        ...
        <el-dialog
          :title="$t('cNam.select')"
          :visible.sync="connectionSelectDialogVisible"
          custom-class="auth-dialog"
          :show-close="false"
          :close-on-click-modal="false"
        >
        ...
        <!--error弹窗-->
        <el-dialog :title="$t('errTitle')" custom-class="error-dialog" :visible.sync="dialogSolutionVisible">
          <div class="error-shooting">
            ...
            <div class="content-item">
              ...
              <div class="desc">
                <p v-for="(item, index) in error.solution" :key="index">{{ index + 1 }}. {{ item }}</p>
              </div>
            </div>
          </div>
        ...
        <!-- Besst Tool 2-->
        <el-dialog :title="$t('toolTitle1')" custom-class="tip-dialog" :visible.sync="besstTool">
          <div class="">
            <div class="">
        ...
        <!-- PC mode -->
        <el-dialog :title="$t('toolTitle2')" custom-class="tip-dialog" :visible.sync="pcMode">
          <div class="">
            <h1>
              {{ $t('tool12') }}
            </h1>
        ...
        <!-- Open Can Controller -->
        <el-dialog :title="$t('toolTitle2')" custom-class="tip-dialog" :visible.sync="usbCanControllerOpen">
          <div class="">
            <h1>
        ...
        <!-- Update Note -->
        <el-dialog title="Diagnosis Update Note" custom-class="tip-dialog" :visible.sync="diagnosisUpdateNoteOpen">
          <div class="notice19">
            <h1>
              {{ $t('notice19_01') }}
            </h1>
...
export default {
  ...
  i18n: {
    messages: {
      ...
      fr: FR.Components.Diagnosis.diagnosis3rd
    }
  },
  ...
  methods: {
    ...
    getVehicle() {
      ...
      Core.Api.Vehicle.vehicleDetailBySn(this.vehicleSn).then((res) => {
      ...
      switch (device) {
        ...
        case Controller:
          ...
          setTimeout(function () {
            ...
            vm.result.controllerOK =
              !!vm.controllerInfo.sn && !!vm.controllerInfo.version && !!vm.controllerInfo.hardVersion && !!vm.controllerInfo.model
        ...
        case Sensor:
          ...
          setTimeout(function () {
            ...
            vm.result.pedalSensorOK =
              !!vm.pedalSensorInfo.sn && !!vm.pedalSensorInfo.version && !!vm.pedalSensorInfo.hardVersion && !!vm.pedalSensorInfo.name
    ...
    startShowPercentage(target, time, start = 0) {
      ...
      let bomPercentage = setInterval(function () {
        target.loaded = false
        target.percentage = target.percentage + perChange > 100 ? 100 : Math.round((target.percentage + perChange) * 100) / 100
...
//                                }
        ...
        if ('current' in res.data.test) {
          ...
          if (this.testSelect.No === 6 || this.testSelect.No === 5 || this.testSelect.No === 7 || this.switchTest) {
            ...
            if (this.testSelect.No === 6 && this.lightFlag.walk && this.testData.current < 3) {
              ...
              if (
                (this.testData.cadence > 20 && this.testData.speed > 6 && this.testData.current > 0.1) ||
                (this.testData.sensorVoltage > 0.75 && this.testData.speed > 6 && this.testData.current > 0.1)
              ) {
    ...
    createReportInfo() {
      let connectListTem = this.connectionSelectDisplay.map(({ No, status, update }) => {
        return { No, status, update }
      })
      let testListTem = this.testSelectDisplay.map(({ No, name, detail, okOrFail }) => {
        return { No, name, detail, okOrFail }
      })
      let allConnectListTem = this.itemList.map((item) => {
        return item.No
      })
      let allTestListTem = this.systemList.map((item) => {
        return item.No
      })
    ...
    goToReport() {
      ...
      this.$router.push({
        ...
        query: {
          ...
          defect: this.defectList,
          file: this.fileAll,
          remark: this.problemText
        }
      })
    },
