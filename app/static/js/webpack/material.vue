 ...
 * @LastEditTime: 2022-07-21 10:07:42
 * @FilePath: /BESST/besst-client/src/views/firmware/channel/material.vue
 * @Description: 
-->
<template>
  <div class="content-wrap">
    <div class="left table-box">
      ...
      <div class="table-start">
        <el-form :inline="true" :model="formSearch">
          ...
          <el-form-item>
            <el-input v-model.trim="formSearch.name" :placeholder="$t('model')"></el-input>
          </el-form-item>
          <el-form-item>
            <el-input v-model.trim="formSearch.extPartNo" :placeholder="$t('partNo')"></el-input>
          </el-form-item>
          <el-form-item>
      ...
      <div class="table-main">
        <el-table @selection-change="selectionChange" v-loading.body="loading" :data="tableData">
          ...
          <el-table-column prop="name" :label="$t('model')" width="250"> </el-table-column>
          <el-table-column prop="ext_part_no" :label="$t('partNo')" show-overflow-tooltip min-width="250"> </el-table-column>
          <el-table-column prop="desc" :label="$t('desc')" show-overflow-tooltip width="200"> </el-table-column>
    ...
    <el-dialog class="dialog-category" :title="$t('selectCategory')" :visible.sync="dialogSelectCategoryVisible" size="large">
...
export default {
  ...
  activated() {
    // !this.firstReq && this.getTableList()
    this.getAllCategory()
  },
  methods: {
    next() {
    ...
    getAllCategory() {
      this.loading = true
      Core.Api.Category.getAllCategoryListOfBafang(Core.Const.COMPONENT_ROOT_CATEGORY).then((res) => {
