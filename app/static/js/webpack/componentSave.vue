<template>
  <div class="componentSave-list">
    <div class="header">
      <el-form :inline="true" class="list-form-inline" @submit.native.prevent>
  ...
  methods: {
    ...
    getRecordList() {
      if (this.org.type === Core.Const.ORG_TYPE.COMPONENT) {
        Core.Api.Object.objectGetAssemblySavedComponent(
          this.sn.trim(),
          this.data.page,
          this.data.pagesize
        ).then((res) => {
        ...
        Core.Api.Object.objectAssemblySavedComponent(
          this.sn.trim(),
          this.data.page,
          this.data.pagesize
        ).then((res) => {
