<template>
  <div class="sidebar Noprint">
    <div class="user-info">
      <div class="logo-div">
        <img class="user-avatar" src="../../assets/images/main/img-default-avatar.png" :src="org.avatar | getImgUrl" />
    ...
    <div class="menu-container">
      <el-menu :default-active="$route.path" class="el-menu-vertical-demo" theme="dark" :default-openeds="defaultOpenList" :unique-opened="true">
        <div v-if="org.type == 1 && !offline" class="new">
          ...
          <el-menu-item index="/brand/model/list" v-if="authList['item.menu']">
            <a class="a-link" @click="$router.push({ path: '/brand/model/list', query: { page: 1, index: 0 } })">
          ...
          <el-submenu index="/brand/partner/dealer" v-if="authList['dealer.menu']">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/dealer.png" />{{ $t('dealer') }} </template>
          ...
          <el-submenu index="/brand/partner/oem" v-if="authList['oem.menu']">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/oem.png" />{{ $t('oem') }} </template>
          ...
          <el-menu-item index="/brand/partner/component/list" v-if="authList['item.menu']">
            <a
              ...
              @click="
                $router.push({
                  path: '/brand/partner/component/list',
                  query: { page: 1, index: 0 }
                })
              "
            >
          ...
          <el-submenu index="/service">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/service.png" />{{ $t('serviceCenter') }} </template>
            ...
            <el-submenu index="/tool" v-if="authList['tool.menu']">
              <template slot="title"
                ><img class="icon" src="../../assets/images/icon/menu/tool.png" /><span class="titleSec">{{ $t('tool') }}</span></template
              >
            ...
            <el-submenu index="/error/shooting">
              <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/error-shooting.png" />{{ $t('faq') }} </template>
        ...
        <div v-else-if="org.type == 1 && offline">
          ...
          <el-submenu index="/component/tool">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/tool.png" />{{ $t('tool') }} </template>
            <el-menu-item index="/brand/tool/hmi">
              <a class="a-link" @click="$router.push('/brand/tool/hmi')">
                <img class="icon" src="../../assets/images/icon/icon-hmi.png" />{{ $t('hmi') }}
              </a>
        ...
        <div v-else-if="org.type == 2" class="new">
          ...
          <el-submenu index="/dealer/service">
            ...
            <el-submenu index="/tool" v-if="authList['tool.menu']">
              <template slot="title"
                ><span class="titleSec">{{ $t('tool') }}</span></template
              >
              <el-menu-item index="/dealer/tool/hmi">
                <a class="a-link" @click="$router.push('/dealer/tool/hmi')">
                  <img src="../../assets/images/icon/icon-hmi.png" class="icon" />{{ $t('hmi') }}
            ...
            <el-submenu index="/error/shooting">
              <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/error-shooting.png" />FAQ </template>
        ...
        <div v-else-if="org.type == 3">
          ...
          <el-submenu index="/assembler/diagnosis">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/diagnosis.png" />{{ $t('diagnosis') }} </template>
        ...
        <div v-else-if="org.type == 4 && !offline">
          ...
          <el-submenu index="/component/param" v-if="authList['product.menu'] && org.id == 25">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/param.png" />{{ $t('tt.param') }} </template>
          ...
          <el-menu-item index="/component/component/list" v-if="authList['object.menu']">
            <a class="a-link" @click="$router.push('/component/component/list')">
              <img class="icon" src="../../assets/images/icon/menu/component.png" />{{ $t('productComponent') }}
            </a>
          </el-menu-item>
          ...
          <el-submenu index="/error/shooting">
            ...
            <el-menu-item index="/component/order/empty-list" v-if="authList['object.delete']">
              <a class="a-link" @click="$router.push('/component/order/empty-list')"> Empty Order List </a>
            </el-menu-item>
          </el-submenu>
          ...
          <el-submenu index="/component/audit-apply/apply" v-show="org.id == 25">
            ...
            <el-menu-item index="/component/audit-apply/apply" v-if="accountType_2">
              <a class="a-link" @click="$router.push('/component/audit-apply/apply')"> Apply BESST Account </a>
            </el-menu-item>
            <el-menu-item index="/component/audit-apply/audit" v-if="accountType_3">
              <a class="a-link" @click="$router.push('/component/audit-apply/audit')"> Audit BESST Account </a>
            </el-menu-item>
            <el-menu-item index="/component/audit-apply/ip">
              <a class="a-link" @click="$router.push('/component/audit-apply/ip')"> IP Verification </a>
            </el-menu-item>
          </el-submenu>
          ...
          <el-menu-item index="/component/security" v-show="org.id == 25">
            <a class="a-link" @click="$router.push('/component/security')">
              <img class="icon" src="../../assets/images/icon/menu/order.png" />Security Code
            </a>
          </el-menu-item>
          <el-submenu index="/component/tool" v-if="authList['tool.menu']">
            <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/tool.png" />{{ $t('tool') }} </template>
            ...
            <el-menu-item index="/component/tool/record" v-show="org.id == 25">
              <a class="a-link" @click="$router.push('/component/tool/record')"> {{ $t('tool') }} {{ $t('record') }} </a>
            </el-menu-item>
            <el-menu-item index="/component/tool/firmware-delete-record" v-show="org.id == 25">
              <a class="a-link" @click="$router.push('/component/tool/operationTraceRecord')"> {{ $t('component') }} {{ $t('record') }} </a>
            </el-menu-item>
            ...
            <el-menu-item index="/component/tool/save" v-show="org.id == 25">
              <a class="a-link" @click="$router.push('/component/tool/save')"> Component Save </a>
            </el-menu-item>
            <!--<el-menu-item index="/record">-->
        ...
        <div v-else-if="org.type == 5 && isSpecial">
          ...
          <el-submenu index="/warehouse">
            ...
            <el-menu-item index="/warehouse/location" @click="$router.push({ path: '/warehouse/location' })">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/receipt.svg" />
                Location
              </a>
          ...
          <!-- after sales -->
          <el-submenu index="/after-sales" v-if="serviceCenter || parcelInformation || customerServiceRecord || technicalService">
            <template slot="title">
              <img class="icon" src="../../assets/images/warehouse/after-sales.svg" />
              After Sales
            </template>
            <el-menu-item v-ilpermission="'service-center'" index="/after-sales/service-center" @click="$router.push('/after-sales/service-center')">
              <a class="a-link">
          ...
          <el-submenu index="/customer-service" v-if="customerServiceUser || technicalServiceUser">
            ...
            <el-menu-item index="/customer-service/carrier-order" @click="$router.push('/customer-service/carrier-order')">
              <a class="a-link">
          ...
          <el-submenu index="/clean-manage" v-if="commercialInvoice || cleanRecord">
            ...
            <el-menu-item v-ilpermission="'clean-record'" index="/clean-manage/clean-record" @click="$router.push('/clean-manage/clean-record')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/cleanRecords.svg" />
                Clean Record
              </a>
          ...
          <el-submenu index="/finance" v-if="invoiceList || cashierList || financeReceptionList">
            ...
            <el-menu-item v-ilpermission="'invoice-list'" index="/finance/invoice-list" @click="$router.push('/finance/invoice-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/invoice.svg" />
                Invoice
              </a>
            </el-menu-item>
            <el-menu-item v-ilpermission="'cashier-list'" index="/finance/cashier" @click="$router.push('/finance/cashier')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/cashier.svg" />
                Cashier
              </a>
            </el-menu-item>
            <el-menu-item v-ilpermission="'finance-reception-list'" index="/finance/reception" @click="$router.push('/finance/reception')">
              <a class="a-link">
          ...
          <el-submenu index="/purchase" v-if="purchaseList">
            ...
            <el-menu-item v-ilpermission="'purchase-list'" index="/purchase/purchase-list" @click="$router.push('/purchase/purchase-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/list.svg" />
                List
              </a>
          ...
          <el-submenu index="/sales" v-if="proformaInvoiceList || deliveryList">
            ...
            <el-menu-item v-ilpermission="'proforma-invoice-list'" index="/sales/proforma-invoice" @click="$router.push('/sales/proforma-invoice')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/PI.svg" />
                PI
              </a>
            </el-menu-item>
            <el-menu-item v-ilpermission="'delivery-list'" index="/sales/delivery-list" @click="$router.push('/sales/delivery-list')">
              <a class="a-link">
          ...
          <el-submenu index="/customer" v-if="true">
            ...
            <el-menu-item index="/customer/customer-list" @click="$router.push('/customer/customer-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/list.svg" />
                List
              </a>
          ...
          <el-submenu index="/department" v-if="departmentList">
            ...
            <el-menu-item v-ilpermission="'department-list'" index="/department/department-list" @click="$router.push('/department/department-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/list.svg" />
                List
              </a>
          ...
          <el-submenu index="/role" v-if="roleList || roleSetting">
            ...
            <el-menu-item v-ilpermission="'role-list'" index="/role/role-list" @click="$router.push('/role/role-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/list.svg" />
                List
              </a>
            </el-menu-item>
            <el-menu-item v-ilpermission="'role-setting'" index="/role/role-setting" @click="$router.push('/role/role-setting')">
              <a class="a-link">
          ...
          <el-submenu index="/user" v-if="userNL">
            ...
            <el-menu-item v-ilpermission="'user-nl'" index="/user/user-list" @click="$router.push('/user/user-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/role-setting.svg" />
                List
              </a>
          ...
          <el-submenu index="/permission" v-if="permissionList || permissionCategory">
            ...
            <el-menu-item v-ilpermission="'permission-list'" index="/permission/permission-list" @click="$router.push('/permission/permission-list')">
              <a class="a-link">
                <img class="icon" src="../../assets/images/warehouse/list.svg" />
                List
              </a>
        ...
        <el-submenu v-if="(org.type == 4 && authList[Core.Const.AUTH_LIST.firmwareMenu]) || org.id == 25" index="/firmware">
          <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/tool.png" />{{ $t('firmware') }} </template>
          <el-menu-item index="/firmware/verify">
            <a class="a-link" @click="$router.push('/firmware/verify')">
              {{ $t('verify') }}
            </a>
          </el-menu-item>
          <el-menu-item index="/firmware/list">
            <a class="a-link" @click="$router.push('/firmware/list')">
              {{ $t('firmware') }}
            </a>
          </el-menu-item>
          <el-menu-item index="/firmware/index/0">
            <a class="a-link" @click="$router.push('/firmware/index/0')">
              {{ $t('channel1') }}
            </a>
          </el-menu-item>
          <el-menu-item index="/firmware/index/1">
            <a class="a-link" @click="$router.push('/firmware/index/1')">
              {{ $t('channel2') }}
            </a>
          </el-menu-item>
          <el-menu-item index="/firmware/index/2">
            <a class="a-link" @click="$router.push('/firmware/index/2')">
              {{ $t('channel3') }}
            </a>
          </el-menu-item>
          <el-menu-item index="/firmware/index/3">
            <a class="a-link" @click="$router.push('/firmware/index/3')">
              {{ $t('channel4') }}
            </a>
          </el-menu-item>
        </el-submenu>
        <!-- <el-submenu index="/sn-entry">
          <template slot="title"> <img class="icon" src="../../assets/images/icon/menu/tool.png" />{{ $t('firmware') }} </template>
          <el-menu-item index="/firmware/index/0">
            <a class="a-link" @click="$router.push('/firmware/index/0')">
              {{ $t('channel1') }}
      ...
      <div class="menu-footer">
        <div class="menu">
          ...
          <div class="menu-item" @click="setting" v-show="!offline && this.org.type !== 6">
            <el-tooltip placement="top" effect="light">
        ...
        <div class="copyright" v-show="this.org.type !== 6">
          ...
          <a href="http://www.bafang-e.com" title="Bafang" class="logo" target="_blank">
            <svg
              ...
              width="170.574px"
              height="48px"
              viewBox="0 0 170.574 48"
              enable-background="new 0 0 170.574 48"
              xml:space="preserve"
