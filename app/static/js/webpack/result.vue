      ...
      <div class="content">
        <div class="bicycle-type mb-10">
          ...
          <el-input
            ...
            disabled
            class="b-type-input inline-block w-200"
          ></el-input>
        </div>
        <table class="component-list" border="0" cellspacing="0" cellpadding="0">
          ...
          <tbody class="t-body">
            <tr v-for="item in tableData">
              ...
              <td class="btn-underline" @click="showDetail(item.key)" v-if="item.show">
                {{ $t("detail") }}
              </td>
              <td v-else>-</td>
            </tr>
        ...
        <div class="result-holder">
          ...
          <div class="result-content">
            <template v-for="item in listStatus">
              <div>
                <span>{{ item.name }}</span>
                <span class="result-span ok" v-if="item.okOrFail == 1">{{
                  $t("ok")
                }}</span>
                <span class="result-span fail" v-if="item.okOrFail == 2">{{
                  $t("fail")
                }}</span>
        ...
        <span class="save-report fr" v-if="!offLineFlag" @click="saveReport">{{
          $t("saveReport")
        }}</span>
          ...
          <el-collapse-item title="Diagnosis Controller" name="3">
            <ul class="list-group">
              <li class="list-group-item">
                <div class="label-title">SN</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.sn + controllerInfo.tip : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.model") }}</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.model : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.softwareVersion") }}</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.version : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.hardwareVersion") }}</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.hardVersion : "-" }}
                </div>
              </li>
              <li class="list-group-item" v-show="!isCan">
                <div class="label-title">{{ $t("cNam.nmlVolt") }}(V)</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.nmlVolt : "-" }}
                </div>
              </li>
              <li class="list-group-item" v-show="!isCan">
                <div class="label-title">{{ $t("cNam.maxCur") }}(A)</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.maxCurrent : "-" }}
                </div>
              </li>
              <li class="list-group-item" v-show="isCan">
                <div class="label-title">{{ $t("cNam.speedLimit") }}(km/h)</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.speedLimit : "-" }}
                </div>
              </li>
              <li class="list-group-item" v-show="isCan">
                <div class="label-title">{{ $t("cNam.wheelDiameter") }}</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.wheelDiameter : "-" }}
                </div>
              </li>
              <li class="list-group-item" v-show="isCan">
                <div class="label-title">{{ $t("cNam.circumference") }}(mm)</div>
                <div class="content">
                  {{ controllerInfo ? controllerInfo.circumference : "-" }}
                </div>
              </li>
            </ul>
          </el-collapse-item>
          <el-collapse-item title="Diagnosis Battery" name="3">
            <ul class="list-group">
              <li class="list-group-item">
                <div class="label-title">SN</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.sn + batteryInfo.tip : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.model") }}</div>
              ...
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.hardwareVersion") }}</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.hardVersion : "-" }}
                </div>
              </li>
              <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <div class="content">
                  {{ batteryInfo ? batteryInfo.packVoltage : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.capacityLeft") }}(mAh)</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.leftCapacity : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.fullChargeCapacity") }}(mAh)</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.fullChargerCapacity : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.temperature") }}(℃)</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.temperature : "-" }}
                </div>
              </li>
              <li class="list-group-item">
              ...
              <li class="list-group-item">
                ...
                <div class="content">
                  {{ batteryInfo ? batteryInfo.lastCharge : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.maxChargeInterval") }}(day)</div>
                <div class="content">
                  {{ batteryInfo ? batteryInfo.maxChargeInterval : "-" }}
                </div>
              </li>
            </ul>
          </el-collapse-item>
          ...
          <el-collapse-item title="Diagnosis Pedal Sensor" name="3">
            <ul class="list-group">
              <li class="list-group-item">
                <div class="label-title">SN</div>
                <div class="content">
                  {{ pedalSensorInfo ? pedalSensorInfo.sn : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.model") }}</div>
                <div class="content">
                  {{ pedalSensorInfo ? pedalSensorInfo.name : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.softwareVersion") }}</div>
                <div class="content">
                  {{ pedalSensorInfo ? pedalSensorInfo.version : "-" }}
                </div>
              </li>
              <li class="list-group-item">
                <div class="label-title">{{ $t("cNam.hardwareVersion") }}</div>
                <div class="content">
                  {{ pedalSensorInfo ? pedalSensorInfo.hardVersion : "-" }}
                </div>
              </li>
            </ul>
          </el-collapse-item>
    ...
    saveReport() {
      ...
      if (!this.vehicleId) {
        this.$message.warning(
          "No bike traced. You could only print the report and save to local."
        );
        return;
      }
      ...
      Core.Api.Vehicle.saveVehicleReport(
        0,
        this.vehicleId,
        this.reportJson,
        defectRes,
        ...
        if (Core.Data.getOrg().type == 1) {
          this.$router.push({
            name: "brandDiagnosisReport",
            query: { id: id, from: "diagnosis3rdResult" },
          });
        }
        if (Core.Data.getOrg().type == 2) {
          this.$router.push({
            name: "dealerDiagnosisReport",
            query: { id: id, from: "diagnosis3rdResult" },
          });
        }
        if (Core.Data.getOrg().type == 3) {
          this.$router.push({
            name: "assemblerDiagnosisReport",
            query: { id: id, from: "diagnosis3rdResult" },
          });
        }
        if (Core.Data.getOrg().type == 4) {
          this.$router.push({
            name: "componentDiagnosisReport",
            query: { id: id, from: "diagnosis3rdResult" },
          });
        }
      });
