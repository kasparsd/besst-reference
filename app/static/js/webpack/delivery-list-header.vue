    ...
    saveDelivery() {
      ...
      this.saveDeliveryInfo(this.formData)
        .then((res) => {
          ...
          scope.formData = JSON.parse(JSON.stringify(res));
          scope.deliveryDate = Core.Util.changeDateForm(res.delivery_date * 1000);
          scope.reviewerDate = Core.Util.changeDateForm(res.reviewer_date * 1000);
          scope.$message({
...
// WEBPACK FOOTER //
// delivery-list-header.vue?a4e1b484