          ...
          <div class="info">
            ...
            <template v-if="testSelect.No == 8">
              <div class="info-left">
                ...
                <div class="item" v-if="hmiInfo.customer_sn">
                  <label class="label">Customer SN</label>
                  <el-input class="input" v-model="hmiInfo.customer_sn"></el-input>
                </div>
                <div class="item">
            ...
            <template v-if="testSelect.No == 9">
              <div class="info-left">
                ...
                <div class="item" v-if="controllerInfo.customer_sn">
                  <label class="label">Customer SN</label>
                  <el-input class="input" v-model="controllerInfo.customer_sn"></el-input>
                </div>
                <div class="item">
                  <label class="label">{{ $t('cNam.model') }}</label>
            ...
            <template v-if="testSelect.No == 10">
              <div class="info-left">
                ...
                <div class="item" v-if="batteryInfo.customer_sn">
                  <label class="label">Customer SN</label>
                  <el-input class="input" v-model="batteryInfo.customer_sn"></el-input>
                </div>
                <div class="item">
                  <label class="label">{{ $t('cNam.model') }}</label>
            ...
            <template v-if="testSelect.No == 11">
              <div class="info-left">
                ...
                <div class="item" v-if="pedalSensorInfo.customer_sn">
                  <label class="label">Customer SN</label>
                  <el-input class="input" v-model="pedalSensorInfo.customer_sn"></el-input>
                </div>
                <div class="item">
                  <label class="label">{{ $t('cNam.softwareVersion') }}</label>
            ...
            <template v-if="testSelect.No == 7">
              <div class="info-left">
                ...
                <div class="item" v-if="motorInfo.customer_sn">
                  <label class="label">Customer SN</label>
                  <el-input class="input" v-model="motorInfo.customer_sn"></el-input>
                </div>
                <div class="item">
          ...
          <template v-if="testSelect.update">
            ...
            <div class="bottom-content">
              <el-table :data="tableData" style="width: 100%" empty-text="No Data">
                <el-table-column prop="version" align="center" label="Version"> </el-table-column>
                ...
                <el-table-column prop="remark" align="center" label="Remark"> </el-table-column>
                <el-table-column align="center" label="Operation">
                  <template slot-scope="scope">
                    <!-- 1 未更新版本 2 已更新版本 -->
                    <div class="operation" @click="goToUpdate(scope.row)" :class="{ active: versionCompare < scope.row.version }">
                      {{ $t('cNam.update') }}
                    </div>
                  </template>
                </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getFileList() {
      ...
      Core.Api.Firmware.getHistoryBySn(this.updateSn).then((res) => {
        let list = res.record
        if (list.length > 3) {
