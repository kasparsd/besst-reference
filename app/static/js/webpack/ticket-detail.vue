  ...
  <div class="ticket-detail">
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="handleUpToBaFang">{{
          $t("confirm")
        }}</el-button>
        <el-button type="primary" @click="dialogHandleUpVisible = false">{{
          $t("cancel")
        }}</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  i18n: {
    messages: {
      fr: FR.Components.ServiceCenter.ticketDetail,
