<template>
  <div class="receipt-order-item-list">
    <div class="header">
      ...
      <label class="title">{{
        orderId ? "Edit Package List" : "Add Package List"
      }}</label>
    </div>
    <div class="content-wrap">
      <div class="content content-set">
        ...
        <div class="footer">
          <el-button type="delete" v-if="isActive" @click="deleteOrderItem">{{
            $t("delete")
          }}</el-button>
          <el-button type="primary" v-if="isActive" @click="createOrder">{{
            $t("saveOrder")
          }}</el-button>
          <el-button
            type="primary"
...
export default {
  data() {
    return {
      ...
      departmentList: [],
      areaCodeList: [],
      tableHead: ["Item Name", "BF Art Nr", "Specification", "Quantity", "Operation"],
...
// WEBPACK FOOTER //
// receipt-order-item-list.vue?68383bba