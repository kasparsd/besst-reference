<template>
  <div class="service-center-save">
    <div class="header">
      ...
      <label class="title">{{
        orderId ? "Edit Service Center" : "Add Service Center"
      }}</label>
    </div>
    <div class="content-wrap">
      <div class="content" v-loading.body="loading">
        <div class="order-info">
          ...
          <div class="left">
            ...
            <div class="item">
              ...
              <el-input class="input" v-model="formData.customer_contact_phone" disabled>
                <el-select
            ...
            <div class="item">
              ...
              <el-input
                class="input"
                v-model="formData.customer_province"
                disabled
              ></el-input>
            </div>
            <div class="item">
            ...
            <div class="item">
              ...
              <el-input
                class="input"
                v-model="formData.customer_district"
                disabled
              ></el-input>
            </div>
            <div class="item">
            ...
            <div class="item">
              ...
              <el-input
                class="input"
                v-model="formData.customer_star"
                disabled
              ></el-input>
            </div>
            <div class="item-row">
              ...
              >
                ...
                >
                  ...
                  <span style="float: right; color: #8492a6; font-size: 12px">{{
                    item.category_root_id | categoryRoot
                  }}</span>
                </el-option>
              </el-select>
            </div>
        ...
        <div class="parts-list">
          <el-button type="primary" @click="createOrder" v-if="!isEditPage"
            >SAVE</el-button
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    handleItemChange(id) {
      ...
      this.formData.customer_contact_country_code = (data && data.country_code) || "+86";
...
// WEBPACK FOOTER //
// service-center-save.vue?a7555106