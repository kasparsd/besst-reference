...
const Login = {
  ...
  declareP7:
    ' Het merk dient een schriftelijke aanvraag in bij de software-eigenaar, Inclusief: de geregistreerde naam van het merk, land, adres, postcode, wettelijk e-mailadres van de managementaccount, merkeigendom certificaat, domeinnaam website, etc.',
  ...
  declareP10:
    'Na het downloaden van de software via autorisatie-informatie, moeten merkbedrijven de relevante informatie nauwkeurig invullen volgens het softwareregistratie  proces om het registratieproces te verbeteren;',
  ...
  declareP21:
    'Vul voor nieuwe geregistreerde gebruikers de "uitnodigingscode" in bij de registratie-interface "Aanmelden" om het e-mailadres als accountnaam te verifiëren;',
  ...
  declareP24:
    'Nadat het wachtwoord met succes is ingesteld, begint u de informatie van dealer of distributeur in te vullen in overeenstemming met het softwareproces, bevestigt u de authenticiteit en geldigheid van de informatie en voltooid u de registratie.',
  declareP25:
    'Vul de volgende keer dat u inlogt uw e-mailadres en wachtwoord in de accountbalk. Het is beter om "Onthoud mij" te markeren, zodat u de volgende keer gemakkelijk kunt inloggen;',
  ...
  declareP28:
    'Ga naar "Fietsverkoop" en registreer klantinformatie, bevestig voertuig-ID, genereer de verkooporder, bepaal het after-sales beleid, vergeet niet de gegevens die op de server zijn opgeslagen te bevestigen.',
  ...
  declareP32:
    'Nadat het wachtwoord met succes is ingesteld, begint u de fabrieksinformatie in te vullen volgens het softwareproces, bevestigt u de authenticiteit en geldigheid van de informatie en voltooid u de registratie. ',
  ...
  declareP34:
    ' "Order" en "Voertuig" verzamelen bedrijfsinformatie van het merk via uitnodigingscodes. Bij het maken van een nieuwe verkooporder moet eerst het merk worden geselecteerd en vervolgens het voertuigtype.',
...
const AttributeName = {
  ...
  speedLimitNote:
    ' Opmerking: de snelheidslimiet is hoger dan 25 km / u. Pas de snelheidslimiet aan binnen de limieten voorgeschreven door de lokale wetgeving.',
  ...
  txtTitleReset:
    'U reset de verbindingsstatus tussen BESST en uw PC. Deze functie is hetzelfde als de resetknop op het BESST-tool. Ook worden alle bestaande gegevens gewist.',
  txtTitleTest:
    'U kunt controleren of het display de diagnose ondersteunt. Verbind het display met de BEEST-tool en zet het display aan, deze zal in de abnormale modus gaan afhankelijk van verschillende types. Klik nu op test, deze springt naar de normale modus als u ook de controller aansluit.',
  ...
  txtNote2:
    ' De gegevens moeten eerst worden gelezen voordat u gaat overschrijven. We registreren elke operatie samen met het SN voor eventuele verdere ondersteuning. ',
  txtNote3:
    ' De gegevens moeten eerst worden gelezen voordat u het update. We registreren elke operatie samen met het SN voor eventuele verdere ondersteuning.',
  ...
  updateToolReconnectTip:
    'Ontkoppel de servicetool van uw PC en sluit deze opnieuw aan. Wanneer de USB HID-statusstip groen wordt, klikt u nogmaals op "Update" ',
  ...
  updateMsgTip:
    ' Nieuwe softwareversie wordt gedetecteerd. U kunt de nieuwste versie selecteren en bijwerken. Als u de volg stappen niet kent, gaat u naar de sectie Tool-Update',
  ...
  updateStep5:
    'Koppel het component los en klik op "Update" om de software naar de servicetool te downloaden. Tijdens dit proces ziet u het lampje van de servicetool "PC" knipperen. Als de LED "PC" altijd brandt, moet u de servicetool resetten naar de normale status en opnieuw opstarten.',
  updateStep6:
    'Na het succesvol downloaden van software naar servicetool, kun je het component opnieuw aansluiten en zal de servicetool de software herschrijven. Klik rechtsboven op het pictogram "Help" voor meer informatie.',
  ...
  pcMode: 'PC modus',
  pcModeTxt:
    ' "PC" -modus wordt gebruikt om gegevens van het display te lezen in vergelijking met de normale werkmodus. Wanneer het display verbinding maakt met BESST-tool, als display kan worden ingeschakeld, gaat het display in de "PC" modus.',
  ...
  connectorType:
    'Als de connector hetzelfde type als afbeelding 1 heeft, klik dan op "UART" om de details van de instructie te controleren. Als de connector hetzelfde type als afbeelding 2 heeft, klik dan op "CAN bus" om de details van de instructie te controleren.',
  ...
  HMISecond:
    '2. Druk op de aan / uit knop van het display om het update proces te starten. Als de update start blijft de servicetool "Uart" LED knipperen. ',
  ...
  ControllerFirst:
    '1. Sluit de controller aan op de servicetool om het updateproces te starten. Als de update start, blijft de servicetool "Uart" LED knipperen. ',
  ...
  HMIFifth:
    '1. Sluit het display aan op de servicetool om het updateproces te starten. Als de update start, blijft de servicetool "CAN Bus" LED knipperen. ',
  ...
  ControllerForth:
    '1. Sluit de controller aan op de servicetool om het updateproces te starten. Als de update start, blijft de servicetool "CAN Bus" LED knipperen. ',
  ...
  thirdVersionFirst:
    '2. Klik eenmaal op "Update" om de software naar de servicetool te downloaden en zichzelf vervolgens bij te werken. Tijdens dit proces ziet u de servicetool "PC" LED knipperen. Als de LED "PC" blijft branden, moet u het servicetool resetten. Als de LED "Test" al brandt, hoeft u enkel opnieuw op "Update" te klikken. ',
  // defect
...
const Index = {
  ...
  updToolNote4:
    "Als de voortgangsbalk van de update niet wordt weergegeven, koppelt u de servicetool los van de computer en sluit deze opnieuw aan. Klik vervolgens op de 'update' knop.",
...
const diagnosis3rd = {
  ...
  case12:
    'Controleer de kabelverbinding. Is het nog steeds niet mogelijk om het display in te schakelen dan heeft u een nieuwe display nodig om verder te gaan.',
  ...
  case181:
    "'op de BESST tool. Is het nog steeds niet mogelijk om het display in te schakelen dan heeft u een nieuwe display nodig om verder te gaan. ",
  case20:
    'Wanneer er nog steeds geen PC modus in het display verschijnt, ondersteunt het BESST niet en u heeft u een nieuw BESST compatible display nodig om verder te gaan.',
  ...
  start19:
    ' Als de verlichting niet werkt, maar u ziet nog steeds het groene lampje, vervang dan de verlichting. Als er geen verlichting brandt of als u geen groen licht ziet, klik dan ',
  ...
  tool12:
    ' "PC" modus wordt gebruikt om gegevens van het scherm te lezen in vergelijking met de normale modus. Wanneer het display verbinding maakt met het BESST-programma en kan worden ingeschakeld, gaat het display naar de "PC" -modus.',
  tool13: 'LCD Display',
  ...
  brake01:
    'Controleer of de remmen van de E-bike zijn uitgerust met een uitschakelfunctie. Als de remmen deze functie niet hebben, klik dan op "Volgende." ',
  brake02:
    'Houd de remhendel vast en laat hem los, herhaal dit meerdere keren, observeer het indicatielampje. Als deze groen en grijs wordt selecteer " Rem stop functie werkt normaal", anders "Rem stop functie is niet werkend." ',
  ...
  light02:
    'Druk op de verlichtingsknop om deze in en uit te schakelen. Selecteer "De indicator functioneert normaal" en "De Indicator functioneert niet". ',
  light022:
    'Controleer of de verlichting normaal in- en uitgeschakeld kan worden, selecteer "De verlichting functioneert normaal", selecteer anders "De verlichting functioneert niet goed" ',
  ...
  support02:
    'Druk op de knop "+/-" om twee keer door het laagste niveau naar het hoogste niveau te gaan, kijk of dit venster en het display consistent zijn. Vervolgens kunt  u "Functioneert normaal" of " Functioneert abnormaal " selecteren. ',
  support03: ' Functioneert normaal',
  support04: ' Functioneert abnormaal',
  speed01:
    'Houd het systeem ingeschakeld, observeer de positie van de snelheidssensor en draai het wiel volgens de richting van de E-bike. Let op de snelheid van bovenstaand venster en het display. Druk op "Snelheidssensor functioneert normaal", anders "Snelheidssensor functioneert niet." ',
  speed04: 'De snelheidssensor functioneert normaal',
  speed05: 'De snelheidssensor functioneert niet.',
  cadence01:
    'Stel het niveau in boven het 1e niveau, draai het pedaal volgens de rijrichting, het observatievenster moet de snelheid weergeven, houd 20RPM langer dan 10 seconden op een constante snelheid, het zal automatisch beoordelen dat "cadanssensor normaal functioneert", druk anders op "Cadanssensor functioneert niet normaal." ',
  cadence03: 'Cadans sensor functioneert niet normaal',
  torque01:
    'Stel het niveau in boven de 1e versnelling, draai snel het pedaal volgens de rijrichting, het observatievenster zal ten minste groter dan 0,75 V, minder dan 5 V weergeven en deze zal veranderen aan de hand van de uitgeoefende kracht, de waarde is hoger dan 0,75 V, het systeem zorgt automatisch voor een gekwalificeerde functie, anders drukt u op "Mislukt". ',
  torque02: 'Als u bevestigt dat het voertuig een torque sensor gebruikt, selecteer dan "T" ',
  walk01: 'Houdt de display knop vast',
  walk02:
    '  /"-" gedurende drie seconden of langer, als de motor draait en de snelheid lager is dan 6 km / h, zal het systeem automatisch beoordelen of deze goed functioneert, klik anders op "WALK communicatiefout." ',
  walk03: 'Druk',
  ...
  notice19_03:
    "Vanwege het verschil tussen de hardware van de servicetool, is er enig bedieningsverschil bij gebruik van servicetool met hardwareversie van 'BESST.UC 3.0'",
...
const diagnosisNormal = {
  ...
  connectTipDialog: {
    ...
    tip: ' Uw browser ondersteunt dit video bestand niet.',
    content:
      ' Verbind aub BESST met het display en controllerkabel en schakel de display in, en controleer vervolgens of het display "PC " (LCD-type) of het LED-lampje Topmodus (LED-type) toont'
  },
  confirmSnDialog: {
    title: 'Bevestig SN',
...
const AssemblerOrderProduce = {
  ...
  connectTipText:
    ' Graag BESST met het display en controller kabel vervinden en zet het display aan, en controleer of het display PC (LCD-Typ) of bij het LED display de bovenste LED toont.',
  confirm: 'Bevestigen',
  ...
  saveSnText:
    ' Het volgende onderdeel SN (serienummer) bestaat niet in BESST. Controleer het SN. Als alles in orde is, kun je het SN nog steeds aan de fiets binden door op "Opslaan" te klikken. Neem contact op met het fietsmerk of de leverancier van componenten als deze situatie zich blijft voordoen.',
