...
const Login = {
  ...
  readmore: '更多',
  declareP1:
    'BESST是为品牌公司开发的电动助力车驱动系统管理软件， 这些品牌将邀请代码发送给其经销商，工厂和分销商，然后注册自己的帐户。每个角色必须确保注册的帐户和密码不与第三方共享，并且品牌负责培训受邀的关系。',
...
const AttributeName = {
  ...
  secondVersionSecond:
    '2.双击“更新”将软件下载到服务工具并进行更新。在此过程中，您将看到服务工具“ PC” LED闪烁。如果“ PC”指示灯保持点亮，则需要将服务工具重置为正常状态。如果“测试”指示灯已经点亮，则只需再次单击“更新”。',
  secondVersionThird: '3.如果更新成功，则服务工具将更改为正常状态。',
  figureFirst: '图1',
  figureSecond: '图2',
  thirdVersionFirst:
    '2.单击一次“更新”，将软件下载到服务工具并进行更新。在此过程中，您将看到服务工具“ PC” LED闪烁。如果“ PC” LED保持点亮，则需要将服务工具重置为正常状态。如果“测试” LED已经点亮，则需要再次单击“更新”。',
  // defect
  bikeLabel_1: '无助力功能',
  ...
  NumberOfFaultTypes: '故障类型个数',
  TotalNumberOfFailures: '故障总个数',
  FaultRecord: '故障记录'
}
...
const Hmi = {
  ...
  mileageTotalSupport: '支持整数值，如1000km。只会写入整数部分数值',
  mileageTotalMax: '最大值为99999。请检查。',
  mileageSingleSupport: '支持类似1000.1km的值。仅写入整数部分和第一位小数部分',
  mileageSingleMax: '最大值为9999.9。请检查。',
  mileageSingleLess: '单个里程不应大于总里程',
  mileageTotalLarger: '总里程不得少于单个里程',
...
const diagnosis3rd = {
  ...
  support04: '非正常工作',
  speed01:
    '保持驱动系统开机状态，观察整车速度检测传感器位置，并按照车辆行驶方向拨动车轮旋转，观察窗口和仪表出现速度显示，请按“速度传感器工作正常”，否则“速度传感器非正常” ',
  speed04: '速度传感器工作正常',
  speed05: '速度传感器非正常',
  cadence01:
    '设置档位1档以上，按照骑行方向旋转脚踏，观察窗口应该显示速度，请匀速保持20RPM并持续10秒以上，将会自动判断“踏频传感器工作正常”，否则请按“踏频传感器不正常”',
  cadence03: '踏频传感器不正常" ',
  torque01:
    '设置档位1档以上，按照骑行方向快速旋转中轴，观察窗口将显示至少大于0.75V，小于5V的值，并随施加力量大小变化为正常，该值大于0.75V，系统自动判断该功能合格，否则请按“Fail”',
  ...
  motor03:
    '3.如果仍然没有没有显示电机工作正常，请将车辆驱动轮置于有阻尼并能转动状态，用脚踏启动电机，观察窗口正常显示电流值，速度和踏频或力矩电压信息，系统将自动判断“电机工作正常”，否则“Fail” ',
...
const AssemblerOrderProduce = {
  ...
  bikeSnExt: '车辆的序列号存在',
  saveSnText:
    'BESST中不存在以下组件SN（序列号）。 请检查SN。 如果一切正常，您仍然可以通过单击“保存”将SN绑定到自行车。 如果这种情况连续发生，请联系自行车品牌或组件供应商。',
