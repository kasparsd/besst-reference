...
const Login = {
  ...
  declareP10:
    'Nach dem Herunterladen und der Installierung der Software im Autorisierung müssen die Markenunternehmen gemäß dem Registrierungsprozess die relevanten Informationen genau ausfüllen;',
  ...
  declareP21:
    'Für neuer Benutzer kann man in der Seite "Neu anmelden" den "Einladungscode" eingeben, um die E-mail-Adresse als Kontonamen zu überprüfen;',
  declareP22: 'Stellen Sie das Passwort ein, nachdem Sie durch den E-Mail einen Bestätigungscode erhalten haben;',
  declareP23:
    'Für Benutzer des alten BESST Systems füllen Sie den "Einladungscode" in "Einladung annehmen" im Tab "Marke" aus und akzeptieren die neue Marke.',
  declareP24:
    'Nach der Einstellung des Passwortes füllen die Händler und Distributoren gemäß dem Registrierungsprozess die relevanten Informationen genau aus, und bestätigen die Authentizität und Rechtmäßigkeit der vorgelegten informationen, um die Registrierung zu beenden.',
  declareP25:
    'Next time you log in, fill in your email number and password in the account bar. It is better to mark "Remember me" so that you can log in easily next time;',
  ...
  declareP28:
    'Im "Verkauf" kann man die Kundeninformationen eintragen, das Fahrrad-IDs, Verkaufslist erstellen und die After-Sales-Richtlinie bestimmen, und erinnern Sie sich, die Daten auf dem Serverzu speichern.',
  ...
  declareP34:
    'Im "Auftrag" und "Fahrzeug" wird die Informationen der Markenunternehmen automatisch versammeln, beim Erstellung der neuen Aufträge muss man zuerst die Marke und dann die Modelle auswählen.',
...
const Sidebar = {
  ...
  channel1: 'Order Model',
  channel2: 'Material Model',
  channel3: 'SN Model',
  channel4: 'Soft-Hardware Model',
  verify: 'Verify'
}
...
const AttributeName = {
  ...
  speedLimitNote:
    'Achtung: Die Geschwindigkeitsbegrenzung liegt über 25Km/h. Bitte passen Sie die Geschwindigkeitsbegrenzung unter der vom lokalen Recht vorgeschriebenen Grenzen an.',
  ...
  txtTitleReset:
    'Der Verbindungsstatus zurücksetzen, diese Funktion ist die gleiche wie Reset-Taste auf BESST-Tool. Auch alle vorhandenen Daten würden gelöscht.',
  txtTitleTest:
    'Achtung: Dieses Tool kann prüfen, ob die Komponente das BESST unterstützt. Durch das Tool kann die Hauptdaten der Komponente anzeigen. Muss man zuerst die Daten ablesen, bevor verändern. Wir tragen jede Vorgänge zusammen mit SN ein.',
  ...
  updateFailTip:
    'Das Werkzeug könnte die Firmware nicht erkennen, und es ist ein Übertragungsfehler aufgetreten. Bitte laden Sie die Firmware erneut herunter.',
  updateToolReconnectTip:
    'Ziehen Sie das Werkzeug zu PC ab und schließen Sie es mit PC erneut an. Wenn der USB-HID-Anzeiger grün wird, klicken Sie erneut auf "Aktualisieren" Button. ',
  ...
  updateMsgTip:
    'Neue Softwareversion wird erkannt. Sie können die neueste Version auswählen und aktualisieren. Wenn Sie diese Vorgang nicht kennen, folgen Sie bitte die Schnitt “ Werkzeug--Update',
  ...
  updateStep3:
    'Klicken Sie auf die Taste "Lesen", um SN und Softwareversion zu ablesen. Falls die SN leer ist, ist die Aktualisierung nicht zulässig.',
  updateStep4: 'Klicken Sie auf die Taste "Datei aus der Cloud herunterladen" oder "Datei aus lokalen herunterladen".',
  updateStep5:
    'Trennen Sie die Komponente ab, und klicken Sie auf "Update", um Software in das BESST-Tool herunterzuladen. Während dieses Prozesses sehen Sie die "PC" LED auf dem Tool blinken. Falls die "PC" LED immer leuchtet, müssen Sie die Taste “reset” auf dem BESST-Tool drücken.',
  updateStep6:
    'Nachdem die Software ins BESST-Tool erfolgreich heruntergeladen ist, können Sie die Komponente wieder anschließen, und das BESST-Tool würde die Software darauf schreiben. Für weitere Details klicken Sie auf das Symbol "?" rechts oben.',
  ...
  pcMode: 'PC-Modus',
  pcModeTxt:
    'PC" Modus wird verwendet, um Daten aus dem Display im Vergleich zum Arbeits-Modus abzulesen. Wenn Display mit BESST-Tool verbunden und eingeschaltet würden, würden Display in den "PC"-Modus wechseln.',
  ...
  connectorType:
    'If the connector has the same type of figure 1, please click "Uart" to check detail of instruction. If the connector has the same type of figure 2, please click "CAN Bus" to check detail of instruction.',
  ...
  secondVersionSecond:
    '2. Double click "Update" to download software to service tool and update itself then.During this process,you will see service tool "PC" LED blinking. If "PC" LED keeps on, you need reset service tool to normal.If "Test" LED already turn on, you just need click "Update" once again.',
  ...
  thirdVersionFirst:
    '2. Click "Update" once to download software to service tool and update itself then.During this process,you will see service tool "PC" LED blinking. If "PC" LED keeps on, you need reset service tool to normal. If "Test" LED already turn on, you need click "Update" again.',
  // defect
  ...
  NumberOfFaultTypes: 'Number of fault types',
  TotalNumberOfFailures: 'Total number of failures',
...
const Hmi = {
  ...
  hmiTip:
    'Die Hauptdaten sind leer. Für UART-System bitte schalten Sie das Display ein, um in den "PC"-Modus zu wechseln, oder für CAN-System bitte überprüfen Sie, ob Display eingeschaltet is.',
...
const Index = {
  ...
  updToolNote1:
    'Das BESST Service-Werkzeug benötigen neue Software zu aktualisieren, damit die Funktionen der Komponenten besser zur Verfügung stehen. ',
  updToolNote: 'Hinweis',
  ...
  updToolNote4:
    'Wenn der Fortschrittsbalken für die Aktualisierung nicht angezeigt wird, trennen Sie das Service-Werkzeug am Computer und stellen Sie erneut eine Verbindung zum PC her. Klicken Sie dann auf "Aktualisieren" Button wieder.',
...
const diagnosis3rd = {
  ...
  start19:
    'Wenn das Licht des Fahrrads nicht funktioniert, Sie aber trotzdem sehen, dass das grüne Licht leuchtet, dann ersetzen Sie das Vordere oder hintere Rücklichtlicht. Wenn das Licht des Fahrrads nicht funktioniert oder das grüne Licht nicht leuchtet, klicken Sie bitte auf den Button',
  ...
  start27:
    'Wenn kein grünes Licht leuch den Bottontet, bitte den Magneten in die richtige Induktionsposition bringen. Wenn es immer noch nicht funktioniert, klicken Sie bitte auf den Botton ',
  ...
  toolTitle2: 'PC modus',
  tool11:
    'Die erste Version des BESST-Tools unterstützt nur das Uart Protokoll, mit Mini USB Port auf der einen Seite und zwei USB Typ B Ports auf der anderen Seite. ',
  tool12:
    ' "Der Modus "PC" dient zum Lesen von Daten aus dem Display im Vergleich zum Arbeitsmodus. Wenn das HMI an das BESST-Tool angeschlossen ist und das Display/HMI eingeschaltet werden konnte, geht es in den Modus "PC" über.',
  tool13: 'LCD Display',
  ...
  errorHmi:
    'Seriennummer ist leer. Display/HMI ist bei BESST nicht registriert. Bitte schließen Sie das HMI wieder an oder prüfen Sie, ob es sich im "PC"-Modus befindet.',
  errorController:
    'SN ist leer. Der Kontroller ist bei BESST nicht registriert. Bitte schließen Sie den Kontroller wieder an oder im Bereich "Werkzeug" testen.',
  ...
  offLineTip:
    'Im Offline-Modus können Sie das Fahrzeug SN eingeben und den Bericht lokal speichern. Bitte klicken Sie auf "Drucken" oben auf dieser Seite.',
  ...
  brake02:
    'Hold the brake lever, and release, repeat multiple times, observe the indicator light, can normally turn green and turn gray, please select "Brakes work normally", otherwise "Brake power off function is not normal" ',
  ...
  light022:
    'Please check whether the headlight is normally turned on and off, please select "Headlights work normally", otherwise please select "Headlight does not work properly" ',
  ...
  support02:
    'Press the “+/-” button to cycle through the lowest level to the highest level twice , observe whether this window and display are consistent and responsive in time. You need to select “Work normally” or “Work abnormally”. ',
  support03: 'Work normally',
  support04: 'Work abnormally',
  speed01:
    'Keep the drive system switched on, observe the vehicle speed detection sensor position, and rotate the exact wheel according to the direction of the vehicle. Observe the speed of this window and the display. Please press "Speed sensor works normally", otherwise "Speed sensor works abnormally. " ',
  speed04: 'The speed sensor works normally',
  speed05: 'The speed sensor works abnormally',
  cadence01:
    'Set the level above 1st level, rotate the pedal according to the riding direction, the observation window should display the speed, please keep 20RPM at a constant speed for more than 10 seconds, it will automatically judge that "Cadence sensor works normally", otherwise press "Cadence sensor works abnormally." ',
  cadence03: 'Cadence sensor works abnormally',
  torque01:
    'Set the level above 1st gear, quickly rotate the middle pedal according to the riding direction, the observation window will display at least greater than 0.75V, less than 5V, and change with the magnitude of the applied force to normal, the value is greater than 0.75V, the system automatically Make sure the function is qualified, otherwise press "Fail". ',
  ...
  walk02:
    ' /"-" for three seconds or more, if the motor rotates and the speed is less than 6km/h, the system will automatically judge OK, otherwise please click "WALK communication failure" ',
  walk03: 'Please press',
  ...
  notice19_02:
    'Die Diagnosefunktion wurde am 19.12.2019 aktualisiert. Seitdem passt Diese Diagnosefunktion möglichweise nicht gut zu einigen CAN-Produkten, die vor Oktober 2019 hergestellt wurden.',
  notice19_03:
    'Weiterhin, aufgrund des Unterschiedes zwischen der Hardware des BESST-Tools gibt es einige Betriebsunterschiede, wenn das BESST-Tool mit der Hardware-Version von BESST.UC 3.0 verwendet wird',
  notice19_04: 'BESST wurde schon aktualisiert, um den Unterschiede zwischen Hardware des Service-Tools zu beseitigen.',
  notice19_05:
    'Hinweis: Wenn Sie kontinuierlich ein CAN-System in der Diagnose stellen, müssen Sie jedes Mal die Stromversorgung des Kontrollers über 20 Sekunden herunterfahren.'
}
...
const diagnosisNormal = {
  ...
  connectTipDialog: {
    ...
    tip: 'Ihr Broser unterstützt kein Video.',
    content:
      'Bitte schließen sie das BESST Tool an das Display und das EB-BUS an. Schalten Sie das Display an: Das Display zeigt folgendes an: "PC"(LCD type)oder der Top Modus LED Licht ( LED type)'
  },
  confirmSnDialog: {
...
const AssemblerOrderProduce = {
  ...
  saveSnText:
    'The following component SN(serial number) is not exist in BESST. Please check the SN. If everything is all right, you can still bind the SN to bike by clicking "Save". If this situation contiune occur, please contact bike brand or component supplier.',
