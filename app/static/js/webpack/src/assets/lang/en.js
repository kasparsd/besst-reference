...
const Login = {
  ...
  declareP7:
    'The brand company shall submit a written application to the software owner, including: the registered name of the brand company, country, address, postal code, legal email address of the management account, brand ownership certificate, website domain name, etc.',
  ...
  declareP10:
    'After downloading the software through authorization information, brand companies must fill in the relevant information accurately according to the software registration process to improve the registration process;',
  ...
  declareP21:
    'For new registered users, fill in "invitation code" in the "Sign up" registration interface to verify the email address as the account name;',
  declareP22: 'After receiving the verification code through the mailbox, set the password;',
  declareP23:
    'For users of the old BESST system, enter "Brand List", fill "Accept Invitation" with" invitation code ", and Accept new Brand invitation.',
  declareP24:
    'After the password is successfully set, start to fill in the information of dealers and distributors in accordance with the software process, and confirm the authenticity and validity of the information, and end the registration.',
  declareP25:
  ...
  declareP28:
    'Enter "Bike Sales", register customer information, confirm vehicle ID, generate Sales order, determine after-sales policy, be sure to confirm the data saved to the server.',
  ...
  declareP32:
    'After the password is successfully set, start to fill in the manufacturing factory information according to the software process, and confirm the authenticity and validity of the information, and end the registration. ',
  ...
  declareP34:
    '"Order" and "Vehicle List" collect brand company information through invitation codes. When creating a new sales Order, the brand should be selected first, and then the Vehicle type should be selected.',
...
const AttributeName = {
  ...
  txtTitleTest:
    'You can check whether the display support diagnosis. Connect HMI to BEEST tool, open the HMI, it will go into the abnormal mode depend different types. Now click test, it will jump to normal interface if you connect controller.',
  ...
  updateMsgTip:
    "New software version is detected.You could select the latest version and update.If you don't know the steps, please go to section Tool-Update",
  ...
  updateStep5:
    'Unplug the component and click "Update" to download software to service tool. During this process,you will see service tool "PC" LED blinking. If the "PC" LED is always on, you need reset service tool to normal state and restart.',
  updateStep6:
    'After downloading software to service tool successfully, you could plug the component and service tool would write software to it. For more detail, click "help" icon on right top.',
  ...
  pcMode: 'PC mode',
  pcModeTxt:
    ' "PC" mode is used to read data from display compared with working mode. When HMI connect to BESST tool,if HMI could be switched on, HMI go into "PC" mode.',
...
const diagnosis3rd = {
  ...
  start19:
    "If the light doesn't work, but you still see the green light, then replace the light. If no light works or you see don't green light, please click",
  ...
  light022:
    'Please check whether the light is normally turned on and off, please select "Light works normally", otherwise please select "Light is abnormal" ',
  ...
  support02:
    'Press the “+/-” button to cycle through the lowest level to the highest level twice , observe whether this window and display are consistent and responsive in time. You need to select “Buttons work normally” or “Buttons are abnormal”. ',
  support03: 'Buttons work normally',
  support04: 'Buttons are abnormal',
  speed01:
    'Keep the drive system switched on, observe the vehicle speed detection sensor position, and rotate the exact wheel according to the direction of the vehicle. Observe the speed of this window and the display. Please press "Speed sensor works normally", otherwise "Speed sensor is abnormal. " ',
  speed04: 'Speed sensor works normally',
  speed05: 'Speed sensor is abnormal',
  cadence01:
    'Set the level above 1st level, rotate the pedal according to the riding direction, the observation window should display the speed, please keep 20RPM at a constant speed for more than 10 seconds, it will automatically judge that "Cadence sensor works normally", otherwise press "Cadence sensor is abnormal." ',
  cadence03: 'Cadence sensor is abnormal',
  torque01:
    'Set the level above 1st gear, quickly rotate the pedal according to the riding direction, the observation window will display at least greater than 0.75V, less than 5V, and change with the magnitude of the applied force to normal, the value is greater than 0.75V, the system automatically Make sure the function is qualified, otherwise press "Fail". ',
  ...
  notice19_02:
    'Diagnosis function was updated on date of 2019.12.19. The diagnosis function might not suit well with some CAN products produced before October 2019.',
  notice19_03:
    "Additionally, because of the difference between service tool's hardware, there is some operation difference when use service tool with hardware version of 'BESST.UC 3.0'.",
...
const diagnosisNormal = {
  ...
  connectTipDialog: {
    ...
    tip: 'Your browser does not support video tag.',
    content:
      'Please connect BESST to HMI and EB-BUS and switch on theHMI, and then check if the HMI displays "PC"(LCD type)or the Top mode LED light(LED type)'
  },
  confirmSnDialog: {
    title: 'Confirm SN',
...
const AssemblerOrderProduce = {
  ...
  connectTipText:
    " Please connect BESST to HMI and EB-BUS and switch on the HMI, and then check if the HMI displays 'PC'(LCD type) or the Top mode LED light(LED type)",
  confirm: 'Confirm',
