...
import SecurityCode from '../views/component/security/list.vue'
import ComponentOrderEmptyList from '../views/component/order/listDelete.vue'
...
// 产品
const productsIndex = () => import('../views/nl-view/products/index')
const inventoryIndex = () => import('../views/nl-view/inventory/index')

// 仓库
const warehouseListIndex = () => import('../views/nl-view/warehouse/warehouseList.vue')
const warehouseAreaIndex = () => import('../views/nl-view/warehouse/area')
const warehouseLocationIndex = () => import('../views/nl-view/warehouse/location')
// 阈值
const thresholdIndex = () => import('../views/nl-view/warehouse/threshold')
// 入库
const stockIn = () => import('../views/nl-view/stocks/in')
const StockInDetail = () => import('../views/nl-view/stocks/in-detail.vue')
// 出库
const stockOut = () => import('../views/nl-view/stocks/out.vue')
const StockOutDetail = () => import('../views/nl-view/stocks/out-detail.vue')

// Firmware
const firmwareIndex = () => import('../views/firmware/index')
const firmwareList = () => import('../views/firmware/list')
const firmwareVerify = () => import('../views/firmware/verify')
Vue.use(Router)
...
let routes = [
  ...
  // 零件
  {
    ...
    children: [
      ...
      { path: 'order/empty-list', name: 'ComponentOrderEmptyList', component: ComponentOrderEmptyList },
      ...
      { path: 'security', name: 'SecurityCode', component: SecurityCode }
    ]
  },
